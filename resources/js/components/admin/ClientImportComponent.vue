<template>
    <div class="client-import">
        ...
        <div class="row mb-4" v-if="step === 1">
            <!-- Columna izquierda: Instrucciones + Upload (75%) -->
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <ol>
                            ...
                            <li>Llena los datos de tus clientes</li>
                            <li>Guarda el archivo como CSV o Excel (.xlsx)</li>
                            <li>Sube el archivo aqui</li>
                        </ol>
                        <a href="/admin/clients/import/template" class="btn btn-outline-primary mb-4">
                    ...
                    <div class="card-body p-0">
                        <table class="table table-sm table-bordered mb-0">
                            ...
                            <tbody>
                                ...
                                <tr><td>Empresa</td><td class="text-center"><span class="badge badge-secondary">No</span></td></tr>
                                <tr><td>Email</td><td class="text-center"><span class="badge badge-secondary">No</span></td></tr>
                                <tr><td>Tel. Movil</td><td class="text-center"><span class="badge badge-secondary">No</span></td></tr>
                                <tr><td>Tel. Fijo</td><td class="text-center"><span class="badge badge-secondary">No</span></td></tr>
                                <tr><td>Direccion</td><td class="text-center"><span class="badge badge-secondary">No</span></td></tr>
                                <tr><td>Colonia</td><td class="text-center"><span class="badge badge-secondary">No</span></td></tr>
                                <tr><td>Ciudad</td><td class="text-center"><span class="badge badge-secondary">No</span></td></tr>
                                <tr><td>Estado</td><td class="text-center"><span class="badge badge-secondary">No</span></td></tr>
                                <tr><td>CP</td><td class="text-center"><span class="badge badge-secondary">No</span></td></tr>
                                <tr><td>Nivel (1,2,3)</td><td class="text-center"><span class="badge badge-secondary">No</span></td></tr>
                                <tr><td>Observaciones</td><td class="text-center"><span class="badge badge-secondary">No</span></td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
                    ...
                    <table class="table table-sm table-bordered table-hover">
                        ...
                        <tbody>
                            <tr v-for="(row, index) in previewData" :key="index" :class="{ 'table-danger': !row.valid }">
                                ...
                                <td>{{ row.city || '-' }}</td>
                                <td>
                                    <span v-if="row.level === 1" class="badge badge-secondary">Basico</span>
                                    <span v-else-if="row.level === 2" class="badge badge-warning">Premium</span>
                                    <span v-else-if="row.level === 3" class="badge badge-success">VIP</span>
                                </td>
                                <td>
        ...
        <div class="card mb-4" v-if="step === 3">
            ...
            <div class="card-body text-center">
                ...
                <h3>{{ importResult.created }} clientes importados correctamente</h3>
...
export default {
    ...
    methods: {
        ...
        uploadFile(file) {
            ...
            axios.post('/admin/clients/import/preview', formData, {
        ...
        executeImport() {
            ...
            const validClients = this.previewData.filter(r => r.valid);

            axios.post('/admin/clients/import/execute', {
