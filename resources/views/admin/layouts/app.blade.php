...
<head>
    ...
    <!-- J2Biznes Design System -->
    <link href="{{ asset('css/j2b-design-system.css') }}" rel="stylesheet">
    <link href="{{ asset('css/admin-dashboard-home.css') }}" rel="stylesheet">
        ...
        <header class="app-header navbar">
            <button class="navbar-toggler mobile-sidebar-toggler d-lg-none mr-auto" type="button">
              <span class="navbar-toggler-icon"></span>
                ...
                <a class="" href="/"><img src="{{ asset('img/j2b_b_60px.png') }}" alt="J2Biznes" style="height: 30px;"></a>
