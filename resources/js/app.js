...
import CfdiBitacoraComponent from './components/admin/CfdiBitacoraComponent.vue';
...
import RentSnmpTokenComponent from './components/admin/snmp/RentSnmpTokenComponent.vue';
import SnmpReadingsComponent from './components/admin/snmp/SnmpReadingsComponent.vue';
import J2MonitorLicenseCard from './components/admin/snmp/J2MonitorLicenseCard.vue';
...
app.component('cfdi-bitacora-component', CfdiBitacoraComponent);
...
app.component('rent-snmp-token-component', RentSnmpTokenComponent);
app.component('snmp-readings-component', SnmpReadingsComponent);
app.component('j2-monitor-license-card', J2MonitorLicenseCard);
